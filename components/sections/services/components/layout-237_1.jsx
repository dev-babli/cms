        ...
        <div className="flex flex-col items-center">
          <div className="mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
            ...
            <p className="text-medium">
              We follow a rigorous methodology to ensure seamless AI integration
          ...
          <div className="grid grid-cols-1 items-start justify-center gap-y-12 md:grid-cols-3 md:gap-x-8 md:gap-y-16 lg:gap-x-12">
            <div className="flex w-full flex-col items-center text-center">
              ...
              <p>
                Understand your unique business requirements and challenges.
              </p>
            </div>
            <div className="flex w-full flex-col items-center text-center">
              <div className="mb-5 md:mb-6">
              ...
              <p>Develop tailored AI strategies aligned with your goals.</p>
            </div>
            <div className="flex w-full flex-col items-center text-center">
              <div className="mb-5 md:mb-6">
                <img
              ...
              <p>Deploy solutions and provide ongoing technical guidance.</p>
            </div>
          </div>
