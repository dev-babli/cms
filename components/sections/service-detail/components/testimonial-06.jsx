      ...
      <div className="container">
        <div className="mb-12 w-full md:mb-18 lg:mb-20">
          ...
          <p className="text-medium">
            Real results from innovative organizations
          </p>
        </div>
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-3 md:gap-x-8 lg:gap-x-12 lg:gap-y-16">
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="heading-h6 font-bold">
              Emscale transformed our entire data strategy with remarkable
              precision.
            </blockquote>
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="heading-h6 font-bold">
              Their AI models delivered insights we never thought possible.
            </blockquote>
            <div className="mt-6 flex w-full flex-col md:mt-8 md:w-auto">
              <div className="mb-4">
                <img
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="heading-h6 font-bold">
              A game-changing approach to enterprise AI implementation.
            </blockquote>
            <div className="mt-6 flex w-full flex-col md:mt-8 md:w-auto">
              <div className="mb-4">
                <img
              ...
              <div className="mb-3 md:mb-4">
                ...
                <p>Head of Innovation, Global Dynamics</p>
              </div>
              <div className="hidden w-px self-stretch bg-scheme-border md:block" />
              <div>
                <img
