/**
 * Script to create a premium blog post about AI
 * This creates a blog post via the API endpoint
 */
...
console.log('\nTo create this post:');
console.log('1. Use the admin interface: /admin/blog/new');
console.log('2. Or use the API: POST /api/cms/blog');
console.log('\nBlog post slug:', blogPostData.slug);
