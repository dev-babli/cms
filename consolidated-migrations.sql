...
CREATE TABLE IF NOT EXISTS categories (
  ...
  slug TEXT UNIQUE NOT NULL,
  description TEXT,
  content_type TEXT DEFAULT 'blog', -- 'blog', 'ebook', 'case_study', 'whitepaper', 'all'
  color TEXT,
  icon TEXT,
  order_index INTEGER DEFAULT 0,
...
-- Add qualification to team_members if it doesn't exist
ALTER TABLE team_members 
ADD COLUMN IF NOT EXISTS qualification TEXT;

-- Add missing fields to categories if they don't exist
...
-- ============================================
-- 8. CONTENT-CATEGORY MAPPING (Many-to-Many)
-- ============================================
